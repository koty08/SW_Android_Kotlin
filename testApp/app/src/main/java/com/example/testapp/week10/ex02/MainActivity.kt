package com.example.week10ex02
...
class MainActivity : AppCompatActivity() {
    ...
    fun ExternalIF() {
        if(Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED) {
            output1.append("ExternalStorage Mounted\n")
            ExternalFile()
        } else {
            output1.append("ExternalStorage Unmounted\n")
        }
    }
    ...
    fun contextFunction(){
        ...
        openFileOutput("context.txt", Context.MODE_PRIVATE).use {
